...
Supply_Phys = "Physical_Supply_Summary.xlsx"
Supply_Mon = "Monetary_Supply_Summary.xlsx"
BEA_Grouping = "BEA_Grouping.xlsx"

Supply_Table_Physical = pd.read_excel(Supply_Phys, sheet_name = None, header = 0, index_col = 0)
Supply_Table_Monetary = pd.read_excel(Supply_Mon, sheet_name = None, header = 0, index_col = 0)
...
Usable_Supply_Mon = reduce_dict(Supply_Table_Monetary, Years_strings)
link_Supply_Mon = tidy_dict(Usable_Supply_Mon, "Mon")
link_Supply_Phys = tidy_dict(Supply_Table_Physical)
...
make_chords(link_Supply_Phys, '_Phys_Supply')
make_chords(link_Supply_Mon, '_Mon_Supply')
